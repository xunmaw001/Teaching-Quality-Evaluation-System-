  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item v-if="flag=='xuesheng'"  label="选修课程" prop="xuanxiukecheng">
          <el-select v-model="ruleForm.xuanxiukecheng"  placeholder="请选择选修课程">
            <el-option
                v-for="(item,index) in xueshengxuanxiukechengOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      <el-col :span="12">
        <el-form-item v-if="flag=='jiaoshi'"  label="所教课程" prop="suojiaokecheng">
          <el-select v-model="ruleForm.suojiaokecheng"  placeholder="请选择所教课程">
            <el-option
                v-for="(item,index) in jiaoshisuojiaokechengOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
...
export default {
  data() {
    return {
      ...
      xueshengxuanxiukechengOptions: [],
      jiaoshixingbieOptions: [],
      jiaoshizhichengOptions: [],
      jiaoshisuojiaokechengOptions: [],
    };
  },
  mounted() {
    ...
    this.$http({
      ...
      if (data && data.code === 0) {
        this.xueshengxuanxiukechengOptions = data.data;
      } else {
        this.$message.error(data.msg);
      }
    });
    ...
    this.$http({
      ...
      if (data && data.code === 0) {
        this.jiaoshisuojiaokechengOptions = data.data;
      } else {
        this.$message.error(data.msg);
      }
    });
