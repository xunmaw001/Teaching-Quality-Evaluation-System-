<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="选修课程" prop="xuanxiukecheng">
          <el-select :disabled="ro.xuanxiukecheng" v-model="ruleForm.xuanxiukecheng" placeholder="请选择选修课程">
            <el-option
                v-for="(item,index) in xuanxiukechengOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              ...
              if (data && data.code === 0) {
                this.xuanxiukechengOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
