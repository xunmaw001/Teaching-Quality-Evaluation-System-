  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.xuexishipin" label="学习视频" prop="xuexishipin">
            <el-button type="text" size="small" @click="download(ruleForm.xuexishipin)">预览</el-button>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="课程类别" prop="kechengleibie">
          <el-select :disabled="ro.kechengleibie" v-model="ruleForm.kechengleibie" placeholder="请选择课程类别">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="授课教师" prop="shoukejiaoshi">
          <el-select :disabled="ro.shoukejiaoshi" @change="shoukejiaoshiChange" v-model="ruleForm.shoukejiaoshi" placeholder="请选择授课教师">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.shoukejiaoshi" label="授课教师" prop="shoukejiaoshi">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="课程简介" prop="kechengjianjie">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.kechengjianjie" label="课程简介" prop="kechengjianjie">
                    <span v-html="ruleForm.kechengjianjie"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/kechengleibie/kechengleibie`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.kechengleibieOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
    ...
    shoukejiaoshiChange () {
      this.$http({
        url: `follow/jiaoshi/jiaoshigonghao?columnValue=`+ this.ruleForm.shoukejiaoshi,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
	...
	this.ruleForm.kechengjianjie = this.ruleForm.kechengjianjie.replace(reg,'../../../ssm708yo/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
