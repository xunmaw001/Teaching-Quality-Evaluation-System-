    ...
    >
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.kechengtupian" label="课程图片" prop="kechengtupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.kechengtupian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="教学方法" prop="jiaoxuefangfa">
          <el-select :disabled="ro.jiaoxuefangfa" v-model="ruleForm.jiaoxuefangfa" placeholder="请选择教学方法">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="教学方法" prop="jiaoxuefangfa">
	      <el-input v-model="ruleForm.jiaoxuefangfa"
                placeholder="教学方法" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="教师评分" prop="jiaoshipingfen">
          <el-select :disabled="ro.jiaoshipingfen" v-model="ruleForm.jiaoshipingfen" placeholder="请选择教师评分">
            <el-option
                v-for="(item,index) in jiaoshipingfenOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="教师评分" prop="jiaoshipingfen">
	      <el-input v-model="ruleForm.jiaoshipingfen"
                placeholder="教师评分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="授课教师" prop="shoukejiaoshi">
          <el-input v-model="ruleForm.shoukejiaoshi" 
              placeholder="授课教师" clearable  :readonly="ro.shoukejiaoshi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="授课教师" prop="shoukejiaoshi">
              <el-input v-model="ruleForm.shoukejiaoshi" 
                placeholder="授课教师" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="选修课程" prop="xuanxiukecheng">
          <el-input v-model="ruleForm.xuanxiukecheng" 
              placeholder="选修课程" clearable  :readonly="ro.xuanxiukecheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="选修课程" prop="xuanxiukecheng">
              <el-input v-model="ruleForm.xuanxiukecheng" 
                placeholder="选修课程" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="学生留言" prop="xueshengliuyan">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="学生留言"
                  v-model="ruleForm.xueshengliuyan" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xueshengliuyan" label="学生留言" prop="xueshengliuyan">
                    <span>{{ruleForm.xueshengliuyan}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	kechengtupian : false,
	jiaoxuefangfa : false,
	jiaoshipingfen : false,
	kechengpingfen : false,
	xueshengliuyan : false,
	shoukejiaoshi : false,
	jiaoshixingming : false,
	xuehao : false,
	xueshengxingming : false,
	yuanxi : false,
	xuanxiukecheng : false,
	userid : false,
      },
      ruleForm: {
        kechengmingcheng: '',
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiaoxuefangfa = true;
          ...
          if(o=='jiaoshipingfen'){
            this.ruleForm.jiaoshipingfen = obj[o];
	    this.ro.jiaoshipingfen = true;
            continue;
          }
          if(o=='kechengpingfen'){
	    ...
	    this.ro.kechengpingfen = true;
          ...
          if(o=='xueshengliuyan'){
            this.ruleForm.xueshengliuyan = obj[o];
	    this.ro.xueshengliuyan = true;
            continue;
          }
          if(o=='shoukejiaoshi'){
	    ...
	    this.ro.yuanxi = true;
          ...
          if(o=='xuanxiukecheng'){
            this.ruleForm.xuanxiukecheng = obj[o];
	    this.ro.xuanxiukecheng = true;
            continue;
          }
          if(o=='userid'){
      ...
      this.$http({
		...
		if(json.xuanxiukecheng!=''&&json.xuanxiukecheng){
                this.ruleForm.xuanxiukecheng = json.xuanxiukecheng
	    		this.ro.xuanxiukecheng = true;
		}
        } else {
          this.$message.error(data.msg);
            ...
            this.jiaoxuefangfaOptions = "1,2,3,4,5".split(',')
            this.jiaoshipingfenOptions = "1,2,3,4,5".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
        url: `jiaoxuepingjia/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `jiaoxuepingjia/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jiaoxuepingjiaCrossAddOrUpdateFlag = false;
						 this.parent.search();
