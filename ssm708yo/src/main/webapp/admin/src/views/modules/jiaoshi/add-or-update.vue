<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="所教课程" prop="suojiaokecheng">
          <el-select :disabled="ro.suojiaokecheng" v-model="ruleForm.suojiaokecheng" placeholder="请选择所教课程">
            <el-option
                v-for="(item,index) in suojiaokechengOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="所教课程" prop="suojiaokecheng">
	      <el-input v-model="ruleForm.suojiaokecheng"
                placeholder="所教课程" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.lianxidianhua = true;
          ...
          if(o=='suojiaokecheng'){
            this.ruleForm.suojiaokecheng = obj[o];
	    this.ro.suojiaokecheng = true;
            continue;
          }
        }
      }
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              ...
              if (data && data.code === 0) {
                this.suojiaokechengOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
